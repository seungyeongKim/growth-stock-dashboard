...
5종목은 장마감 후 자동매매 스케줄러가 끝난 뒤 매일 저녁 깊게 추적하고, 20개 관찰군은 매주 월요일 저녁에 점검합니다.

- 실행 시간: 한국시간 월요일 저녁 7시 15분
...
- 후보 추출 작업: `KiwoomDailyCandidateScan`
- 실행 스크립트: `C:\public\kiwoom-auto-trader\scripts\run_candidate_scan.ps1`
- 실제 후보 추출 모드: `python -m kiwoom_pullback_bot --mode BUILD_CANDIDATES`
- 2026-08-19 후보 추출 종료: 16:35:27
- 최근 장마감 후 가장 늦게 끝난 작업: `KiwoomEventLogArchive`, 대체로 18:10~18:12 종료

따라서 성장주 대시보드 자동화는 장마감 후 작업 종료 여유를 두고 19:00 이후로 실행합니다.
